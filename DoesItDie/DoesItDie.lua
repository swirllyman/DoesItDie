...
-- Generated by tools/make_textures.py. Found under whatever folder the addon is installed in.
local TEXTURE_DIR = "Interface\\AddOns\\" .. ADDON_NAME .. "\\Textures\\"
...
frame:SetScript("OnEvent", function(self, event, ...)
    if event == "ADDON_LOADED" then
        ...
        if #added > 0 then trace("NAMES from this client: " .. table.concat(added, ", ")) end
